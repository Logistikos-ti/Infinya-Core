...
export const produtoFormSchema = z
  .object({
    ...
    qtdMinima: z.coerce.number().nonnegative("O estoque mínimo não pode ser negativo.").optional(),
    qtdMaxima: z.coerce.number().nonnegative("O estoque máximo não pode ser negativo.").optional(),
    pontoReposicao: z.coerce.number().nonnegative("O ponto de reposição não pode ser negativo.").optional(),
    custoReposicao: z.coerce.number().nonnegative("O custo de reposição não pode ser negativo.").optional(),
