...
import { DivisaoLoteDepositanteListClient } from "./divisao-lote-depositante-list-client";

export default async function MobileDivisaoLoteDepositantesPage() {
  ...
  return <DivisaoLoteDepositanteListClient depositantes={depositantes} />;
}
