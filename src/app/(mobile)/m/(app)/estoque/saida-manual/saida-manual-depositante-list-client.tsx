...
export function SaidaManualDepositanteListClient({ depositantes }: { depositantes: DepositanteRow[] }) {
  ...
  return (
    <MobileListShell
      ...
      emptyLabel="Nenhum depositante com saldo disponível para saída."
