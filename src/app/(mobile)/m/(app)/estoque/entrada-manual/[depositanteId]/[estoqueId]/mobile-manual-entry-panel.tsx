...
export function MobileManualEntryPanel({
  ...
  const scanTitle = scanPhase === "produto" ? "Bipe o produto" : scanPhase === "endereco" ? "Bipe o endereço" : "Confirme a entrada";
      ...
      {scannerOpen ? (
        <div style={{ position: "fixed", inset: 0, zIndex: 300, background: "#000", display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            <button
              type="button"
              onClick={() => router.push(`/m/estoque/entrada-manual/${depositanteId}`)}
