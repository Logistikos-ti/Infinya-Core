...
export function AppChrome({ children, user, navCounts }: AppChromeProps) {
  ...
  const isQuarentenaFullBleed = currentPath === "/estoque/quarentena";
  const isInventarioFullBleed = currentPath === "/estoque/inventarios";
  const isDashboardFullBleed = currentPath === "/dashboard";
