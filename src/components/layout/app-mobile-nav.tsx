...
import { Boxes, ClipboardCheck, House, LogOut, PackageCheck, ScanLine, Settings2 } from "lucide-react";
...
const mobileNavigation: ReadonlyArray<{
  ...
  { href: "/recebimento", label: "Receb.", icon: PackageCheck, module: "recebimento" },
  {
    ...
    label: "Separa\u00E7\u00E3o", icon: ScanLine,
    module: "expedicao",
    match: ["/expedicao/separacao"],
  },
  {
    href: "/expedicao/conferencia",
    label: "Confer.", icon: ClipboardCheck,
    module: "expedicao",
...
export function AppMobileNav({ currentPath, user }: AppMobileNavProps) {
  ...
  const navigationItems = isCatalogOnly
    ? [
        ...
        { href: "/configuracoes/produtos", label: "Produtos", icon: Settings2, match: ["/configuracoes", "/configuracoes/produtos"] },
