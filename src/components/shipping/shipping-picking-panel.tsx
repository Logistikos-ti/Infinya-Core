      ...
      <div className="grid gap-4 xl:grid-cols-[320px_minmax(0,1fr)]">
        ...
        <form action={savePickingProgressAction} className="space-y-4">
          ...
          <div className="sticky bottom-20 z-20 rounded-2xl border border-slate-200 bg-white p-4 shadow-lg lg:bottom-4">
            {isWarningVisible ? (
              <div className="mb-3 rounded-2xl border border-rose-200 bg-gradient-to-r from-rose-50 to-amber-50 px-4 py-3 text-sm text-rose-950 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div>
                  ...
                  <div className="rounded-2xl bg-white px-3 py-2 text-center shadow-sm">
                    ...
                    <p className="text-lg font-bold text-rose-700">{countdownSeconds}s</p>
                  </div>
                </div>
              </div>
            ) : null}
