  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950/70">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h2 className="text-lg font-semibold text-slate-950 dark:text-white">Conferência operacional</h2>
        ...
        <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:bg-slate-900/60 dark:text-slate-300">
          <p>
            Recebido: <strong className="text-slate-950 dark:text-white">{progress.received}</strong>
          </p>
          <p>
            Previsto: <strong className="text-slate-950 dark:text-white">{progress.expected}</strong>
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1fr_1fr]">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900/60">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-sm font-semibold text-slate-950 dark:text-white">Leitura por câmera</p>
          ...
          <div className="mt-3 overflow-hidden rounded-2xl border border-slate-200 bg-slate-900 dark:border-slate-700">
            <video
              ref={videoRef}
              playsInline
              muted
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  <p className="text-base font-semibold text-slate-950 dark:text-white">{item.sku}</p>
                  {activeItemId === item.id ? (
