...
export function NovoDepositanteTrigger() {
  ...
  return (
    <>
      <button
        ...
        className="novo-depositante-btn inline-flex shrink-0 items-center gap-2"
        style={{
          ...manropeStyle,
          height: "44px",
          padding: "0 20px",
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex flex-col bg-[#F5F7FB] dark:bg-[#0A1120]" style={manropeStyle}>
          <DepositanteForm onClose={handleClose} />
        </div>
      ) : null}
    </>
  );
