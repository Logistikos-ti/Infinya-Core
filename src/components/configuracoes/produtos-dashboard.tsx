...
export function ProdutosDashboard({
  ...
  const kpis = useMemo(() => {
    ...
    return [
      { label: "SKUs ativos", value: totalProducts, delta: "↓ 62", deltaColor: "#10B981", iconEl: <Package className="w-5 h-5" />, iconBg: "rgba(59,130,246,0.14)", iconColor: "#3B82F6" },
      ...
      { label: "Estoque baixo", value: baixos, delta: "↑ 9", deltaColor: "#F59E0B", iconEl: <AlertTriangle className="w-5 h-5" />, iconBg: "rgba(245,158,11,0.14)", iconColor: "#F59E0B" },
      { label: "Em ruptura", value: rupturas, delta: "↓ 4", deltaColor: "#10B981", iconEl: <Tag className="w-5 h-5" />, iconBg: "rgba(239,68,68,0.14)", iconColor: "#EF4444" },
    ];
