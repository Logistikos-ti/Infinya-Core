...
} from "@/app/(dashboard)/configuracoes/usuarios/actions";
import { UsuarioForm, type UsuarioFormDefaults, type UsuarioFormDepositanteOption } from "./usuario-form";
...
export function UsuarioRowActions({
  ...
  editDefaults: UsuarioFormDefaults;
  ...
  function handleConfirmDelete() {
    ...
    startDelete(async () => {
      ...
      const result = await deleteUsuarioAction(formData);
  ...
  return (
    ...
    >
      ...
      <form action={toggleUsuarioStatusAction} style={{ display: "inline-flex" }}>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: "999px",
            border: "none",
            cursor: isCurrentUser && ativo ? "not-allowed" : "pointer",
            background: ativo ? "#10B981" : "rgba(148,163,184,0.25)",
            transition: "background 0.25s",
            padding: 0,
            opacity: isCurrentUser && ativo ? 0.5 : 1,
          }}
        >
          <span
            style={{
