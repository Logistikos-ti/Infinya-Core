  ...
  return <div className="grid min-h-[520px] gap-5 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.4fr)]">
    <div className="flex flex-col gap-4">
      <div className="flex-1 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-[#101b30]">
        ...
        <button type="button" onClick={submitTicket} className="mt-4 inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-violet-500 text-sm font-bold text-white shadow-lg shadow-indigo-500/20"><Send className="h-4 w-4" />Enviar chamado</button>
