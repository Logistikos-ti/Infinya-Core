      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-slate-950">Alertas de integração</h2>
          </div>
      ...
      <div className="mt-5 space-y-3">
        {alerts.length ? (
          ...
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-6 text-sm text-emerald-800">
            Nenhuma falha ativa no momento. As integrações estão estáveis dentro dos critérios monitorados.
          </div>
        )}
      </div>
    </div>
